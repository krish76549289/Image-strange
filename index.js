...
async function uploadToImgbb(fileLink, filename = 'STRANGER BOY.jpg') {
  try {
...
bot.start(async (ctx) => {
  ...
  const photoUrl = 'https://i.ibb.co/ccV44ZRS/STRANGER-BOY.jpg'; // change your photo URL
  ...
  try {
    ...
    await ctx.replyWithPhoto(photoUrl, {
      ...
      reply_markup: {
        inline_keyboard: [
          [{ text: '✨ Join our Channel ✨', url: 'https://t.me/+y2CPW9niqs0wMzI1' }]
        ]
      }
    });
...
bot.on('photo', async (ctx) => {
  try {
    ...
    const photoUrl = 'https://i.ibb.co/Myt6d4wd/Angel.jpg'; // Photo link to be replied with the message
